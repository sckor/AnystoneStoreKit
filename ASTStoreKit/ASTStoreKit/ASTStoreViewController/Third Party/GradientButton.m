...
//  http://iphonedevelopment.blogspot.com/2010/05/programmatic-gradient-buttons.html
...
- (CGGradientRef)normalGradient
{
    if (normalGradient == NULL)
    {
        ...
        for (unsigned int i = 0; i < [normalGradientLocations count]; i++)
        {
...
- (CGGradientRef)highlightGradient
{
    ...
    if (highlightGradient == NULL)
    {
        ...
        for (unsigned int i = 0; i < [highlightGradientLocations count]; i++)
        {
...
- (void)useBlueConfirmStyle
{
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:5];
    UIColor *color = [UIColor colorWithRed:0.15 green:0.152 blue:0.767 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.566 green:0.566 blue:0.941 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.341 green:0.345 blue:0.85 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.0 green:0.0 blue:0.692 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.0 green:0.0 blue:0.692 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    self.normalGradientColors = colors;
    ...
    NSMutableArray *colors2 = [NSMutableArray arrayWithCapacity:5];
    color = [UIColor colorWithRed:0.009 green:0.005 blue:0.567 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.562 green:0.562 blue:0.854 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.212 green:0.212 blue:0.643 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.153 green:0.152 blue:0.6 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.004 green:0.0 blue:0.488 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
